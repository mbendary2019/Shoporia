  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-100 dark:bg-gray-900">
      ...
      <main className="flex-1">
        ...
        <section className="relative">
          ...
          <div className="relative h-[400px] sm:h-[450px] md:h-[500px] overflow-hidden">
            {heroSlides.map((slide, index) => (
              ...
              >
                <div className={cn('h-full bg-gradient-to-l relative', slide.bg)}>
                  {/* Background Image */}
                  <Image
                    src={slide.image}
                    alt={slide.title}
                    ...
                    priority={index === 0}
                  />
                  <div className="absolute inset-0 bg-gradient-to-l from-transparent via-amazon-navy/70 to-amazon-navy/90" />

                  <div className="container-custom h-full flex items-center relative z-10">
                    <div className="max-w-xl text-white px-4 sm:px-0">
                      <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4">{slide.title}</h1>
                      <p className="text-base sm:text-lg md:text-xl text-white/80 mb-4 sm:mb-6">{slide.subtitle}</p>
                      <Link href={slide.href}>
                        <Button size="lg" className="bg-amazon-yellow hover:bg-amazon-yellowHover text-amazon-navy font-bold text-sm sm:text-base">
                          {slide.cta}
                          <ArrowLeft className="h-4 w-4 sm:h-5 sm:w-5 me-2" />
                        </Button>
                      </Link>
                    </div>
                  </div>
        ...
        <section className="relative -mt-16 sm:-mt-20 z-10 pb-6 sm:pb-8">
              ...
              {STORE_CATEGORIES.slice(0, 6).map((category) => {
                ...
                return (
                  <Link
                    ...
                    className="group"
                  >
                    <Card className="p-2 sm:p-4 text-center transition-all hover:shadow-xl hover:-translate-y-1 bg-white">
                      <div className="mx-auto flex h-10 w-10 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-amazon-orange/10 text-amazon-orange transition-all group-hover:bg-amazon-orange group-hover:text-white">
                        <Icon className="h-5 w-5 sm:h-8 sm:w-8" />
                      </div>
                      <h3 className="mt-2 sm:mt-3 font-medium text-gray-900 text-xs sm:text-sm line-clamp-1">
                        {category.nameAr}
                      </h3>
                    </Card>
                  </Link>
        ...
        {/* Flash Deals Section */}
        <section className="py-6 sm:py-8 bg-gradient-to-l from-amazon-deal/10 to-red-50 dark:from-amazon-deal/20 dark:to-gray-800">
          <div className="container-custom px-3 sm:px-4">
            {/* Header */}
            <div className="flex flex-col gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="flex h-8 w-8 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-amazon-deal text-white animate-pulse">
        ...
        {/* Features Banner */}
        <section className="py-4 sm:py-8 bg-amazon-navy">
          <div className="container-custom px-3 sm:px-4">
