    ...
    <div className="flex min-h-screen flex-col bg-gray-100 dark:bg-gray-900">
      ...
      <main className="flex-1">
          ...
          <div className="container-custom">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-white">
                <Badge className="bg-white/20 text-white mb-4">{t('forAuthors')}</Badge>
            ...
            <div className="max-w-md mx-auto space-y-4">
              {formats.map((format) => (
                <Card key={format.name} className="p-4 flex items-center justify-between">
                  ...
                  {format.available ? (
                    <Badge className="bg-green-100 text-green-700">{t('available')}</Badge>
                  ) : (
                    <Badge className="bg-gray-100 text-gray-500">{t('comingSoon')}</Badge>
                  )}
                </Card>
              ))}
            </div>
        ...
        <section className="py-12 bg-purple-600 text-white">
          <div className="container-custom text-center">
            <h2 className="text-2xl font-bold mb-4">{t('publishToday')}</h2>
            <p className="text-white/80 mb-6">
              {t('publishTodayDescription')}
            </p>
